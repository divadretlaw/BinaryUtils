//
//  DataKeyedDecodingContainer.swift
//  BinaryUtils
//
...
final class DataKeyedDecodingContainer<Key>: KeyedDecodingContainerProtocol where Key: CodingKey {
    ...
    func superDecoder(forKey key: Key) throws -> any Decoder {
        DataDecoder(referencing: decoder.storage, at: decoder.codingPath + [key], options: decoder.options)
    }
